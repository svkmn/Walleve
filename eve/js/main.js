document.addEventListener('DOMContentLoaded', () => {
    ...
    const shouldResume = sessionStorage.getItem(AUDIO_RESUME_FLAG) === '1';
    ...
    const startAudio = () => {
        ...
        siteAudio.currentTime = shouldResume && typeof state.currentTime === 'number' && state.currentTime > 0 ? state.currentTime : 0;
    ...
    window.addEventListener('beforeunload', () => saveAudioState(siteAudio));
    window.addEventListener('pagehide', () => saveAudioState(siteAudio));
